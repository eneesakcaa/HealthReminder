...
fun main_page(navController: NavController){
    ...
    Box(modifier = Modifier.fillMaxSize()){
        ...
        Row(modifier = Modifier.padding(2.dp).fillMaxWidth(), horizontalArrangement = Arrangement.Center) {
            Text(modifier = Modifier.padding(5.dp),text = "ana sayfa")
        }

        Row(modifier = Modifier
            .align(Alignment.BottomCenter) .fillMaxWidth().background(color = MaterialTheme.colorScheme.primaryContainer)){
